...
> This document contains `[SQUARE-BRACKET PLACEHOLDERS]` that the supplier must complete (legal entity name, ABN, address, contact details, governing state/territory, liability cap). It must be reviewed by a qualified Australian lawyer before publication or use.
...
1.1 These Terms of Service ("**Terms**") are a legal agreement between you and **[SUPPLIER LEGAL ENTITY NAME]** ABN **[__ ___ ___ ___]** ("**we**", "**us**", "**Supplier**") in relation to the Camog clinical photo documentation software, including any copies and any updates we release ("**Software**").
...
9.1 Updates are distributed as downloadable installers from **[DISTRIBUTION URL — e.g. github.com/jsaenz03/camorg/releases]**. The Software has no automatic updater; you choose whether and when to install updates.
...
We may amend these Terms from time to time. Material changes will be published at **[DISTRIBUTION URL]** with the relevant release. If you install or continue using the Software after the amended Terms take effect, you accept the amended Terms.
...
**[SUPPLIER LEGAL ENTITY NAME]** · ABN **[__ ___ ___ ___]** · **[POSTAL ADDRESS]** · Email: **[SUPPORT EMAIL]** · Phone: **[PHONE]** · Distribution: **[URL]**
