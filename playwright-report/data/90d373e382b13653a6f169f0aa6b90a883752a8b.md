...
- Name: capture-with-data.spec.ts >> Capture Page - Photo with Dummy Data >> verify patient list shows dummy patient after creation
- Location: tests/capture-with-data.spec.ts:102:7
...
- searchbox "Search patients by name...": John Doe
- img
